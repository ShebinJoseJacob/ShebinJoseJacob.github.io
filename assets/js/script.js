...
function handleNotifications(event) {
    ...
    if (value == 0) {
        ...
        curlups = curlups + 1;
        firebase.database().ref(today + '/exercise/curlups').update({
            curlups: parseInt(curlups),
        });
    }
}
...
const firebaseConfig = {
    apikey: "AIzaSyD_s8OdY9dSI97wdo6yoqzKkAXTdblemhE",  authDomain: "tracker-5ce1c.firebaseapp.com",  databaseURL: "https://tracker-5ce1c-default-rtdb.firebaseio.com",  projectId: "tracker-5ce1c",  storageBucket: "tracker-5ce1c.appspot.com",  messagingSenderId: "873988893274",  appId: "1:873988893274:web:2b0ad32be64388b0a48663",  measurementId: "G-QQCM0WMLH1"
  };
